...
(defn notify-clients [{:keys [com.tyrkinn.bookshelf/chat-clients]} tx]
...
(defn ws-handler [{:keys [com.tyrkinn.bookshelf/chat-clients] :as ctx}]
  {:status 101
